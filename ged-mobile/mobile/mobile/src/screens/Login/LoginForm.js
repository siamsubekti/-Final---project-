...
import { StyleSheet, AsyncStorage as AsyncStorage, View, Image, TouchableOpacity } from 'react-native';
  ...
  handleClick = (event) => {
    ...
    AuthService.login(credentials).then(res => {
      ...
      if (res.status === 200) {
        ...
        } else if (this.containsRoles(res.data.role[0].roleName, "post storage")) {
      ...
      <View style={styles.containerStyle}>
        ...
        <Form style={styles.formLoginStyle}>
          <Item>
            ...
            onChangeText={email => this.setState({ email })} placeholder="username" />
          </Item>
          <Item>
            <Input 
          ...
          <Button
          onPress={this.handleClick.bind(this)} block info style={styles.footerBottomStyle}>
