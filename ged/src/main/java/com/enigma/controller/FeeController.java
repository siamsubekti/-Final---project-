...
public class FeeController {
    ...
    @GetMapping("fee/{location1}/{location2}")
    public Fee findByOriginAndDestination(@PathVariable Locations locations, @PathVariable Locations locations2) {
        return feeService.findByOriginLocationAndDestinationLocation(locations, locations2);
    }
}
