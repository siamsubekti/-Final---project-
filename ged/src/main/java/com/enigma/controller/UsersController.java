...
public class UsersController {
    ...
    @GetMapping("/courier")
    public List<User> getAllCourier(Integer roles){
        return usersService.findByRoleCourier(UsersConstant.COURIER_ID);
    }

    @GetMapping(value = "", params = {"id", "name"})
    public List<User> findByCourierAndName(@RequestParam(value = "id") String id,@RequestParam(value = "name") String keyword) {
        return usersService.findByRolesCourierAndName(id, keyword);
    }
